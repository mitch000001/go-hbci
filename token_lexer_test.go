	...
	tests := []tokenLexerTestData{
		{
			...
			tokens(GROUP_DATA_ELEMENT, GROUP_DATA_ELEMENT, EOF),
		},
		{
			tokens(ALPHA_NUMERIC, DATA_ELEMENT_SEPARATOR, NUMERIC, SEGMENT_END_MARKER, EOF),
			tokens(DATA_ELEMENT, DATA_ELEMENT, EOF),
		},
		{
			...
			tokens(GROUP_DATA_ELEMENT, GROUP_DATA_ELEMENT, GROUP_DATA_ELEMENT, DATA_ELEMENT, EOF),
		},
		{
		...
		{
			tokens(GROUP_DATA_ELEMENT, GROUP_DATA_ELEMENT, GROUP_DATA_ELEMENT, EOF),
