...
var (
	_ BankSegment = &CommunicationAccessResponseSegment{}
)

func init() {
	s := CommunicationAccessResponseSegment{}
	KnownSegments.mustAddToIndex(VersionedSegment{s.ID(), s.Version()}, func() Segment { return &CommunicationAccessResponseSegment{} })
}
